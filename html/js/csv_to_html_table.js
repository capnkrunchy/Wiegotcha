function init_table(options) {
    ...
    $.when($.get(csv_path)).then(
        function (data) {
            ...
            table_head += "<th>Custom Buttons</th>";
            ...
            for (row_id = 1; row_id < csv_data.length; row_id++) {
                ...
                row_html += '<td> \
                                <a class="button" href = "/cgi-bin/simulatecard.sh?' + csv_data[row_id][4] + '" target = "_blank" >Simulate</a> \
                                <a href = "/cgi-bin/writecard.sh?' + csv_data[row_id][4] + '" target = "_blank" >Clone</a> \
                            </td > ';
